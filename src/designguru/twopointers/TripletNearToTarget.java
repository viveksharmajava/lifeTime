...
public class TripletNearToTarget {
	...
	public static void main(String[] args) {
		...
		int [] arr = {-1, 0, 2, 3};
		System.out.println("hello ="+triplet2Pointers(arr,3));
	    System.out.println(findTripletWithSumNearToTarget(arr,3));
		...
		int [] arr2 = {-1, 0, 2, 3};
        System.out.println("searchTriplet="+searchTriplet(arr2,3));
	}
